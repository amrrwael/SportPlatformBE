...
namespace PlatformSport.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomPlayers", x => new { x.PlayersId, x.RoomId });
                    table.ForeignKey(
                        name: "FK_RoomPlayers_AspNetUsers_PlayersId",
